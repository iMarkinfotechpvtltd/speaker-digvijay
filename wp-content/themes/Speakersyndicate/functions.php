...
// Add  image size
add_image_size( 'home-slider', 1920, 579, true );	
//add_image_size( 'home-slider', 1920, 459, true );	
// Set mail from
function your_email( $original_email_address )
{
return 'info@speakersyndicate.stagingdevsite.com';
}
add_filter( 'wp_mail_from', 'your_email' );
add_filter( 'wp_mail_from_name', 'custom_wp_mail_from_name' );
function custom_wp_mail_from_name( $original_email_from ) {
	return 'Speakersyndicate';
}
// Start session
...
function my_custom_post_package() {
 $labels = array(
   'name' => 'package',
 ...
 add_action( 'init', 'my_custom_post_package' );

 // IMAGE SIZES
add_image_size( 'description', 1918, 459);
