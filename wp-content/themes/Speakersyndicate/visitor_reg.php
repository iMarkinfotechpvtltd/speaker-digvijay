...
session_start();
	...
	$visitor_website				=	$_POST['visitor_website'];
	$_SESSION['visitor_website'] 	= 	$visitor_website;
	$visitor_website				=	$_POST['visitor_website'];
	$_SESSION['visitor_website'] 	= 	$visitor_website;
		$subject = 'Speakersyndicate Registration';
		$body = '<h2>Thanks for fill the form.</h2></br></br><p>Please click on this <a href="'.site_url().'/program-description/">link  </a> to complete your registration.</p>';
